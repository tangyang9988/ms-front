...
//地表水趋势分析折线图/squirrel-airq/trendAnalysis/getLine
...
export const getLine = (treeId, time, type) => {
  return request({
    url: '/api/squirrel-airq/trendAnalysis/getLine',
    method: 'get',
    params: {
      treeId,
      time,
...
//地表水趋势分析因子列表/squirrel-airq/trendAnalysis/getFactorList
export const getFactorList = (treeIds) => {
  return request({
    url: '/api/squirrel-airq/trendAnalysis/getFactorList',
    method: 'get',
    params: {
      treeIds
    }
...
// 风速
export const getWind = (treeId, time, type) => {
  return request({
    url: '/api/squirrel-airq/trendAnalysis/getWind',
    method: 'get',
    params: {
      treeId,
      time,
