<template>
  <div class="realMonitor_wrapper loam_wel_realMonitor_wrapper noScroll">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="9" :offset="9">
        <div class="grid-content">
          <el-row :gutter="20">
            <el-col :span="5"><div class="grid-content">全部（{{ totalCom }}）</div></el-col>
            <el-col :span="5"><div class="grid-content">正常（{{ normalCom }}）</div></el-col>
            <el-col :span="5"><div class="grid-content">异常（{{ abnormalCom }}）</div></el-col>
            <el-col :span="5"><div class="grid-content">在线（{{ onlineCom }}）</div></el-col>
            <el-col :span="4"><div class="grid-content">离线（{{ offlineCom }}）</div></el-col>
          </el-row>
        </div>
      </el-col>
...
//			this.count++
//			this.tableData.shift();
//			if(this.count<=this.allData.length-1){
//				this.tableData.push(this.allData[this.count])
//			}else{
//				this.count=0
//				this.tableData.push(this.allData[this.count])
//			}
      ...
      getHead().then(res => {
        if(res.data.success) {
          ...
          getData().then(gisRes => {
            ...
            this.tableData=resData.gisVOList
            
            this.len=resData.gisVOList.length
