      ...
      <tr>
        <td>
          <el-row :gutter="20">
            <!-- 当前异常 -->
            <el-col :span="12" >
              <div class="module_container" @click="linkUrl(1)">
                <table class="module_table">
                  ...
                  <tr>
                    <td>
                      <div class="abnormal_title">当前异常 {{ countCurrent }}</div>
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <!-- 前24h异常 -->
            <el-col :span="12" >
              <div class="module_container" @click="linkUrl(2)">
                <table class="module_table">
                  <tr>
                    <td width=60>
                  ...
                  <tr>
                    <td>
                      <div class="abnormal_title">前24h异常 {{ countBefore24h }}</div>
                    </td>
                  </tr>
                </table>
              </div>
      ...
      <tr>
        <td>
          <el-row :gutter="20">
            ...
            <!-- 本月异常 -->
            <el-col :span="12" >
              <div class="module_container" @click="linkUrl(4)">
                <table class="module_table">
                  <tr>
                    <td width=60>
                  ...
                  <tr>
                    <td>
                      <div class="abnormal_title">本月异常 {{ countMonth }}</div>
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <!-- 前24h未处理异常 -->
            <el-col :span="12" >
              <div class="module_container" @click="linkUrl(3)">
                <table class="module_table">
                  <tr>
                    <td width=60>
                  ...
                  <tr>
                    <td>
                      <div class="abnormal_title">前24h未处理异常 {{ countBefore24hUnDeal }}</div>
                    </td>
                  </tr>
                </table>
              </div>
...
<script>
import { getAbnormalCount } from "@/api/psoa32/abnormal";
...
export default {
  ...
  methods: {
  	linkUrl(num){
  		  console.log(num)
				this.$router.push({
					path: '/abnormalCondition',
					query: {
						indexAbnormalType: num,
					}
				})
  	},
    getAbnormal: function() {
      getAbnormalCount().then(res => {
        ...
        this.countCurrent = res.data.data.countCurrent ? res.data.data.countCurrent : 0
        this.countBefore24h = res.data.data.countBefore24h ? res.data.data.countBefore24h : 0
        this.countMonth = res.data.data.countMonth ? res.data.data.countMonth : 0
        this.countBefore24hUnDeal = res.data.data.countBefore24hUnDeal ? res.data.data.countBefore24hUnDeal : 0
      });
    }
  }
}
