<template>
	<div>
		...
		<el-tree ref="tree" node-key="key" :data="treeData" :props="defaultProps"  :default-expanded-keys="expandedList"
				...
				getDeptTree(this.deviceType).then(res => {
					if(res.data.data.length > 0) {
						...
						this.$nextTick(function() {
							...
							// 设置展开的节点
							this.expandedList.push(firstNode.key)
							// 设置当前选中的节点
