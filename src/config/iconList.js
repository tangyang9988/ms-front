export default [
  ...
  },
  {
    label: "阿里图标库",
    list: [
      "iconfont iconqiehuanxitong",
      "iconfont iconyiqiyibiao",
      "iconfont iconshebeifenzuguanli",
      "iconfont iconshebei",
      "iconfont iconzhujizu",
      "iconfont iconcz-ycpz",
      "iconfont iconshishishuju",
      "iconfont iconchart",
      "iconfont iconsynthetic-data",
      "iconfont iconGIS",
      "iconfont icondibiaoshui",
      "iconfont iconshuju",
      "iconfont iconshishishuju1",
      "iconfont iconkongqizhiliang",
      "iconfont iconyujing1",
      "iconfont iconshui",
      "iconfont iconxunhuan",
    ]
  }
