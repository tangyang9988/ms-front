<template>
	<el-row style="height:calc(100% - 40px)" class="bigdata-setting">
        <basic-container>
            <dashboard design-mode></dashboard>
        </basic-container>
	</el-row>
</template>

<script>
import dashboard from "@/components/dashboard/dashboard-bigdata.vue";
