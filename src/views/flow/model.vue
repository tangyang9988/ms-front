...
<script>
  ...
  import {getGlobalConfig} from "@/api/common/common";
  ...
  export default {
    ...
    methods: {
      ...
      handleCreate() {
        ...
        this.flowUrl = `${this.flowDesignUrl}/index.html`;

        this.flowBox = true;
      },
      handleUpdate(row) {
        //this.flowUrl = `${website.flowDesignUrl}/index.html#/editor/${row.id}`;
        this.flowUrl = `${this.flowDesignUrl}/index.html#/editor/${row.id}`;
        this.flowBox = true;
      },
      handleDeploy(row) {
        this.deployBox = true;
      ...
      handleDownload(row) {
        ...
        window.open(`${this.flowDesignUrl}/app/rest/models/${row.id}/bpmn20`);
      },
    ...
    mounted:function(){
      getGlobalConfig().then(res=>{
        const data = res.data.data;
        this.flowDesignUrl = data.flowDesignUrl;
      });
    }
  };
</script>
