...
import { getAllMobileSiteRank } from "@/api/microstation/index.js";
...
export default {
  ...
  methods: {
    movingRowClick(row, column, event){
      this.$emit("movingRowClick",[row.latitude,row.logitude]);
    },
    // 尘源排名
    rankLoad() {
...
.wrpm {
  ...
  .close-qxpm {
    ...
    // height: 150px;
    height: 75%;
    background-image: url(/img/system/shou.png);
    background-size: 100% 100%;
    position: absolute;
    top: 50%;
